...
// English: A component to compress PNG images. Note: Browser-based PNG compression is limited and may only strip metadata.
...
const PngCompress: React.FC = () => {
  ...
  // English: The core compression logic. Draws the PNG to a canvas and re-encodes it,
  // which can strip metadata and potentially reduce file size.
  const handleCompress = async (values: typeof form.values) => {
    await onActionMellowtel(async () => {
        ...
        return new Promise<ProcessedFile | null>((resolve) => {
          ...
          reader.onload = (e) => {
            ...
            img.onload = () => {
              ...
              // English: The 'quality' argument is not supported for 'image/png' in most browsers.
              // The compression achieved here is through re-encoding, which can strip metadata.
              canvas.toBlob((blob) => {
                if (blob) {
      ...
      if (results.some((r) => r !== null)) {
        ...
        toast.error('Processing failed for all files.')
      }
    })
  }
  ...
  const handleDownloadAll = async () => {
    ...
    FileSaver.saveAs(content, 'compressed-png-images.zip')
  }
    ...
    <LayoutTool>
      <Stack>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="lg">
          Reduce the file size of your PNG images through optimization and
          metadata removal.
        </Text>
                ...
                <Card withBorder p="xl" radius="md">
                  <Stack>
                    ...
                    <Text size="sm" c="dimmed">
                      PNG compression is lossless. This tool optimizes images by
                      re-encoding them, which can result in a smaller file size.
                    </Text>
                  </Stack>
                </Card>
                <Group grow>
                ...
                {processedFiles.length > 0 ? (
                  ...
                  <Center h="80%">
                    <Stack align="center" gap="md">
                      ...
                      />
                      <Text c="dimmed">
                        Your compressed PNGs will appear here.
                      </Text>
                    </Stack>
                  </Center>
                )}
