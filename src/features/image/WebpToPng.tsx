...
// English: A component to convert WebP images to the PNG format.
        ...
        return new Promise<ProcessedFile | null>((resolve) => {
          ...
          reader.onload = (e) => {
            ...
            img.onload = () => {
              ...
              canvas.toBlob((blob) => {
                if (blob) {
                  const newName = `${values.prefix}-${file.name.replace(/\.webp$/i, '')}.png`
                  resolve({
                    blob,
    ...
    <LayoutTool>
      <Stack>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="lg">
          Convert your WebP images to the high-quality PNG format, preserving
          transparency.
        </Text>
