...
// English: A component to convert SVG images to JPG format with scaling, quality, and background color options.
...
const SvgToJpg: React.FC = () => {
  ...
  const form = useForm({
    ...
    validate: {
      ...
      scale: (value) =>
        value > 0 && value <= 10 ? null : 'Scale must be between 1 and 10.',
    },
  })
        ...
        return new Promise<ProcessedFile | null>((resolve) => {
          ...
          reader.onload = (e) => {
            ...
            img.onload = () => {
              ...
              const newWidth = img.width * values.scale
              const newHeight = img.height * values.scale
              ...
              canvas.toBlob(
                (blob) => {
                  if (blob) {
                    const newName = `${values.prefix}-${file.name.replace(/\.svg$/i, '')}.jpg`
                    resolve({
                      blob,
    ...
    <LayoutTool>
      <Stack>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="lg">
          Convert your SVG files to JPG images with custom resolution and
          quality.
        </Text>
              ...
              <Stack>
                <Card withBorder p="xl" radius="md">
                  <Dropzone
                    ...
                    onReject={() =>
                      toast.error('Please upload only SVG images.')
                    }
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        <Text size="xl" inline>
                          Drag SVG files here or click
                        </Text>
                        <Text size="sm" c="dimmed" inline mt={7}>
                          Convert vector graphics to JPG.
                        </Text>
                      </div>
                    </Group>
                  </Dropzone>
                ...
                <Card withBorder p="xl" radius="md">
                  <Stack>
                    ...
                    <NumberInput
                      ...
                      description="Multiplier for the output image size."
                      min={1}
                      max={10}
                      step={0.5}
