...
// English: A component to convert SVG images to PNG format with resolution scaling.
        ...
        return new Promise<ProcessedFile | null>((resolve) => {
          ...
          reader.onload = (e) => {
            ...
            img.onload = () => {
              ...
              canvas.toBlob((blob) => {
                if (blob) {
                  const newName = `${values.prefix}-${file.name.replace(/\.svg$/i, '')}.png`
                  resolve({
                    blob,
    ...
    <LayoutTool>
      <Stack>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="lg">
          Convert your scalable SVG files to high-quality PNG images.
        </Text>
                ...
                <Card withBorder p="xl" radius="md">
                  <Stack>
                    ...
                    <NumberInput
                      ...
                      description="Multiplier for the output image size (e.g., 2x)."
                      min={1}
                      max={10}
                      step={0.5}
