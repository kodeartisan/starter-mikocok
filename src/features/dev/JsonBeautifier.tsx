// src/features/Generator/JsonBeautifier.tsx
  ...
  const handleSubmit = async (values: { input: string }) => {
    await onActionMellowtel(() => {
      ...
      try {
        ...
        const result = JSON.stringify(parsedJson, null, 2) // 2 spaces for indentation
        setOutput(result)
      } catch (error: any) {
    ...
    <LayoutTool width={1000}>
      <Stack>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="lg">
          Format your JSON data into a human-readable, indented structure,
