// src/features/Generator/JsBeautifier.tsx
  ...
  const handleSubmit = async (values: { input: string }) => {
    await onActionMellowtel(() => {
      ...
      try {
        ...
        const result = beautifyJs(values.input, options)
        setOutput(result)
      } catch (error: any) {
    ...
    <LayoutTool width={1000}>
      <Stack>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="lg">
          Format your JavaScript code to be compliant with modern coding
          standards, improving readability.
        </Text>
