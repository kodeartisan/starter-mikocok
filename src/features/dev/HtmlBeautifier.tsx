// src/features/Generator/HtmlBeautifier.tsx
  ...
  const handleSubmit = async (values: { input: string }) => {
    await onActionMellowtel(() => {
      ...
      try {
        ...
        const result = beautifyHtml(values.input, options)
        setOutput(result)
      } catch (error: any) {
    ...
    <LayoutTool width={1000}>
      <Stack>
        ...
        <Text c="dimmed" size="sm" ta="center" mb="lg">
          Clean up and format your HTML code, making it properly indented and
          easy to read.
        </Text>
